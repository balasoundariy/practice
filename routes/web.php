...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('/settlement', '\App\Http\Controllers\AdminController@settlements')->name('settlements');
    ...
    Route::get('/export', '\App\Http\Controllers\AdminController@export')->name('export');
});
